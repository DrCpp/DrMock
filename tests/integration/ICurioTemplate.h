...
#ifndef DRMOCK_TESTS_INTEGRATION_ICURIOTEMPLATE_H
#define DRMOCK_TESTS_INTEGRATION_ICURIOTEMPLATE_H
...
public:
  ...
  virtual ~ICurioTemplate() = default;
...
#endif /* DRMOCK_TESTS_INTEGRATION_ICURIOTEMPLATE_H */
