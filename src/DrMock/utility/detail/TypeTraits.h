...
#ifndef DRMOCK_SRC_DRMOCK_UTILITY_DETAIL_TYPETRAITS_H
#define DRMOCK_SRC_DRMOCK_UTILITY_DETAIL_TYPETRAITS_H
...
#endif /* DRMOCK_SRC_DRMOCK_UTILITY_DETAIL_TYPETRAITS_H */
