...
* [Setup](#setup)
* [Including the mock object header](#including-the-mock-object-header)
* [Using the mock object](#using-the-mock-object)
* [Running the tests](#running-the-tests)
* [DrMock API](#drmock-api)
  + [`Behavior` API](#behavior-api)
  + [`BehaviorQueue` API](#behaviorqueue-api)
  + [Failure](#failure)
  + [Examples](#examples)
* [Details](#details)
  ...
  + [Operators](#operators)
  + [Mocking non-abstract classes](#mocking-non-abstract-classes)
* [`drmock_library` and `drmock-generator`](#drmock_library-and-drmock-generator)
